...
import { CarOutlined, KeyOutlined, UserOutlined } from '@ant-design/icons';
  ...
  return (
    <div style={container} className={outer}>
      ...
      <div className={inner}>
        ...
        <Input className='mb-4' size="large" placeholder="Email" type='text' prefix={<UserOutlined />} value={email} onChange={(e) => {
